<script>
	...
	let { 
		...
		/** Optional series aligned with `data` (e.g. rolling average), drawn as a line */
		lineValues = null,
		lineColor = '#1f2937'
		...
		<div class="chart-container">
			...
			<div class="bars-container">
				...
				<div class="plot-area">
					...
					{#if lineValues && lineValues.length === processedData.length && processedData.length > 0}
						<svg
							class="line-overlay"
							viewBox="0 0 100 100"
							...
							<polyline
								...
								points={lineValues
									.map((lv, i) => {
										...
										const x = ((i + 0.5) / n) * 100;
										const y =
											scaleMax > 0 ? 100 - (lv / scaleMax) * 100 : 100;
										return `${x},${y}`;
									})
									.join(' ')}
							/>
